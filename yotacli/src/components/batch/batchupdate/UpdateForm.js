...
const UpdateForm = (props) => {
  ...
  const onHandleUpdate = async (e) => {
    ...
    dispatch(
      ...
      .then((response) => {
        window.alert(
          `"Batch details with Identifier: " ${updateBatchData.batchIdentifier} " updated Sucessfully"`
        );
      })
            ...
            <div className={`col-6 ${classes.inputName}`}>
              <td>
                <div style={{ marginLeft: "40px" }}>
                  <label for="BatchName" className={classes.label}>
                    Batch Name
                  </label>
                </div>
              </td>
